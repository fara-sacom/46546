...
4. Every product that comes back under that line gets written down on the reorder list — a physical notebook page kept in the shop, not a spreadsheet or app — so it doesn't get lost by the end of the week.
...
- The reorder notebook — a physical page kept in the shop. Nothing digital to connect here; this step happens by hand, off of what FARA reads out.
